...
class Status(_object):
    ...
    if _newclass:
        ...
        OK = _pywrap_tensorflow.Status_OK
...
def RunCppShapeInference(graph_def_version, serialized_node_def, input_serialized_shapes, input_constant_tensor_values, input_constant_tensor_as_shape_values, out_status):
    return _pywrap_tensorflow.RunCppShapeInference(graph_def_version, serialized_node_def, input_serialized_shapes, input_constant_tensor_values, input_constant_tensor_as_shape_values, out_status)
